...
describe User do
  ...
  it "should reject invalid emails" do
    addresses = %w[user@foo,com user_at_foo.bar.org first.last@foo.jp.]
    addresses.each do |address|
  ...
  describe "password validations" do
    ...
    it "should require a matching password confiramtion" do
  ...
  describe "password encryption" do
    ...
    describe "authenticate method" do
      ...
      it "should retutn nil for an email address with no user" do
